...
#     titles.append(re.compile('[^가-힣|a-z|A-Z]').sub(' ', titles_tag.text))   # 모든 한글 조합 문자, 모든 영어 소문자, 모든 영어 대문자
# print(titles)
# print(len(titles))
...
for i in range(6):
    resp = requests.get('https://news.naver.com/main/main.naver?mode=LSD&mid=shm&sid1=10{}'.format(i))                  # {} 자리를 i로 채워줌